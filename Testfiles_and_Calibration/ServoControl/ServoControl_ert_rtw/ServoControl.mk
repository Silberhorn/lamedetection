###########################################################################
## Makefile generated for Simulink model 'ServoControl'. 
## 
## Makefile     : ServoControl.mk
## Generated on : Thu Mar 28 10:29:20 2019
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ServoControl.elf
...
MODELREF_LINK_RSPFILE_NAME = ServoControl_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ServoControl.elf
...
DEFINES_STANDARD = -DMODEL=ServoControl -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = MW_SCI.c ServoControl.c ServoControl_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c ext_svr.c updown.c ext_work.c rtiostream_utils.c linuxinitialize.c rtiostream_interface.c rtiostream_tcpip.c
...
OBJS = MW_SCI.c.o ServoControl.c.o ServoControl_data.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
