###########################################################################
## Makefile generated for Simulink model 'lanedetection_hough_test'. 
## 
## Makefile     : lanedetection_hough_test.mk
## Generated on : Wed Apr 10 13:25:17 2019
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/lanedetection_hough_test.elf
...
PRODUCT_NAME              = lanedetection_hough_test
MAKEFILE                  = lanedetection_hough_test.mk
COMPUTER                  = GLNX
MATLAB_ROOT               = .
MATLAB_BIN                = .
...
MODELREF_LINK_RSPFILE_NAME = lanedetection_hough_test_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/lanedetection_hough_test.elf
...
DEFINES_STANDARD = -DMODEL=lanedetection_hough_test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = MW_SDL_video_display.c v4l2_capture.c v4l2_capture_linux.c hough_d_rt.c hough_r_rt.c lanedetection_hough_test.c lanedetection_hough_test_data.c ext_svr.c updown.c ext_work.c rtiostream_utils.c linuxinitialize.c rtiostream_interface.c rtiostream_tcpip.c
...
OBJS = MW_SDL_video_display.c.o v4l2_capture.c.o v4l2_capture_linux.c.o hough_d_rt.c.o hough_r_rt.c.o lanedetection_hough_test.c.o lanedetection_hough_test_data.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
