 ...
 *
 * File: lanedetection_hough_test.h
 *
...
#ifndef RTW_HEADER_lanedetection_hough_test_h_
#define RTW_HEADER_lanedetection_hough_test_h_
#include <math.h>
#include <string.h>
#include <float.h>
#include <stddef.h>
#ifndef lanedetection_hough_test_COMMON_INCLUDES_
# define lanedetection_hough_test_COMMON_INCLUDES_
#include <math.h>
#include "rtwtypes.h"
...
#endif                                 /* lanedetection_hough_test_COMMON_INCLUDES_ */

#include "lanedetection_hough_test_types.h"
...
typedef struct {
  real32_T HoughTransform_o1[71820];   /* '<Root>/Hough Transform' */
  uint8_T ColorSpaceConversion[19200];
  real32_T HoughTransform_o2[180];     /* '<Root>/Hough Transform' */
  real32_T HoughTransform_o3[399];     /* '<Root>/Hough Transform' */
  ...
  uint8_T DrawShapes_o1[19200];        /* '<Root>/Draw Shapes' */
  uint8_T DrawShapes_o2[19200];        /* '<Root>/Draw Shapes' */
  uint8_T DrawShapes_o3[19200];        /* '<Root>/Draw Shapes' */
  uint8_T pln2[19200];
  uint8_T pln3[19200];
  boolean_T Transpose[19200];          /* '<Root>/Transpose' */
  ...
  real32_T y[2];                       /* '<Root>/MATLAB Function' */
  ...
  int32_T jRowsIn;
  uint32_T acc;
} B_lanedetection_hough_test_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  codertarget_linux_blocks_SDLV_T obj; /* '<S2>/MATLAB System' */
  real32_T FindLocalMaxima_TEMP_IN_DWORKS[71820];/* '<Root>/Find Local Maxima' */
  ...
  uint8_T ColorSpaceConversion_DWORK1[19200];/* '<Root>/Color Space  Conversion' */
  int32_T DrawShapes_DW_Polygon[72];   /* '<Root>/Draw Shapes' */
  int32_T DrawShapes_DW_Points[16];    /* '<Root>/Draw Shapes' */
} DW_lanedetection_hough_test_T;
...
} ConstP_lanedetection_hough_te_T;

/* Parameters (default storage) */
struct P_lanedetection_hough_test_T_ {
...
struct tag_RTM_lanedetection_hough_t_T {
...
extern P_lanedetection_hough_test_T lanedetection_hough_test_P;

/* Block signals (default storage) */
extern B_lanedetection_hough_test_T lanedetection_hough_test_B;

/* Block states (default storage) */
extern DW_lanedetection_hough_test_T lanedetection_hough_test_DW;

/* Constant parameters (default storage) */
extern const ConstP_lanedetection_hough_te_T lanedetection_hough_test_ConstP;

/* Model entry point functions */
extern void lanedetection_hough_test_initialize(void);
extern void lanedetection_hough_test_step(void);
extern void lanedetection_hough_test_terminate(void);

/* Real-time Model object */
extern RT_MODEL_lanedetection_hough__T *const lanedetection_hough_test_M;
 ...
 *
 * '<Root>' : 'lanedetection_hough_test'
 * '<S1>'   : 'lanedetection_hough_test/MATLAB Function'
 * '<S2>'   : 'lanedetection_hough_test/SDL Video Display'
 */
#endif                                 /* RTW_HEADER_lanedetection_hough_test_h_ */
