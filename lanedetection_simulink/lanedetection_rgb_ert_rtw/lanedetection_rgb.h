...
typedef struct {
  ...
  int32_T tmpOutRC[4];
  real32_T FindLocalMaxima_o2;         /* '<Root>/Find Local Maxima' */
...
typedef struct {
  int8_T EdgeDetection_GV_SQUARED_DW[22120];/* '<Root>/Edge Detection' */
  int8_T EdgeDetection_GRAD_SUM_DW[22120];/* '<Root>/Edge Detection' */
  ...
  int8_T EdgeDetection_GH_SQUARED_DW[22120];/* '<Root>/Edge Detection' */
 ...
 * '<S1>'   : 'lanedetection_rgb/SDL Video Display'
 * '<S2>'   : 'lanedetection_rgb/img_ROI'
 */
