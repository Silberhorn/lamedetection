###########################################################################
## Makefile generated for Simulink model 'lanedetection_Kopie'. 
## 
## Makefile     : lanedetection_Kopie.mk
## Generated on : Fri Apr 12 12:20:26 2019
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/lanedetection_Kopie.elf
...
PRODUCT_NAME              = lanedetection_Kopie
MAKEFILE                  = lanedetection_Kopie.mk
COMPUTER                  = GLNX
MATLAB_ROOT               = .
MATLAB_BIN                = .
...
MODELREF_LINK_RSPFILE_NAME = lanedetection_Kopie_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/lanedetection_Kopie.elf
...
DEFINES_STANDARD = -DMODEL=lanedetection_Kopie -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = MW_SCI.c MW_SDL_video_display.c v4l2_capture.c v4l2_capture_linux.c lanedetection_Kopie.c lanedetection_Kopie_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c ext_svr.c updown.c ext_work.c rtiostream_utils.c linuxinitialize.c rtiostream_interface.c rtiostream_tcpip.c
...
OBJS = MW_SCI.c.o MW_SDL_video_display.c.o v4l2_capture.c.o v4l2_capture_linux.c.o lanedetection_Kopie.c.o lanedetection_Kopie_data.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
