 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon May 27 16:03:18 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME signdetection
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            1
/* Input Port  0 */
#define IN_PORT_0_NAME        image
...
extern void signdetection_Start_wrapper(void);
extern void signdetection_Outputs_wrapper(const uint8_T *image,
			boolean_T *stop);
/*====================*
 * S-function methods *
 *====================*/
...
{
    const uint8_T *image = (uint8_T *) ssGetInputPortRealSignal(S, 0);
    boolean_T *stop = (boolean_T *) ssGetOutputPortRealSignal(S, 0);

    signdetection_Outputs_wrapper(image, stop);
